...
<div class="container">
    ...
    <div class="card w-50 mt-3 mx-auto" style="border-color: #c88a72">
        <div class="card-body">
            ...
            <p class="ml-4"> Nurul(018327326) <br> Rumah <br> Desa Geritan RT 05 RW 01 </p>
            <p class="ml-4"> </p>
        </div>
    </div>
    <div class="card w-50 mt-4 mx-auto" style="border-color: #c88a72">
        <div class="card-body">
            ...
            <div class="d-flex">
                ...
                <div class="p-2 "></div>
                <div class="p-2" style="color: rgb(175, 174, 174)">Jumlah</div>
                <div class="p-2" style="color: rgb(175, 174, 174)">Total</div>
            </div>
            <div class="d-flex">
                <div class="mr-auto p-2">Paket A</div>
                <div class="p-2"></div>
                <div class="p-2">1</div>
                <div class="p-2">Rp. 14.000.000 </div>
            </div>
    ...
    <div class="card w-50 mt-4 mx-auto" style="border-color: #c88a72">
        <div class="card-body">
            <div class="d-flex">
                ...
                <div><a href="" style="color: rgb(175, 174, 174)">Pilih</a></div>
            </div>
        </div>
        ...
        <div class="p-3 ml-auto">
            <a href="" role="button" class="btn btn-primary mr-auto">Bayar</a>
        </div>
    </div>
