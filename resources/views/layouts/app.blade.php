...
<body>
    ...
    {{-- <nav class="navbar navbar-expand-md navbar-dark shadow-sm" style="background-color: #0b9999">
        <div class="container">
            ...
            <div class="mx-auto">
                ...
                <a href="https://www.instagram.com/gatro_dekorasipati/"><img src="{{ asset('img/ig1.png') }}" width="30px" height="30px" class="mx-2" alt=""></a> 
                <img src="{{ asset('img/wa.png') }}" width="30px" height="30px" alt=""> 
    ...
    <footer class="w-100" style="background-image: url(img/foot.png); height:230px;">

        <div class="d-block w-100 pt-5">
            <div class="d-flex w-100 justify-content-center">
                <h5 style="color: #636464; font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif">INTERESTED WITH US ?</h5 style="color: #0b9999">
            </div>
            <div class="d-flex justify-content-center mt-3">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" style="color: white" fill="currentColor" class="bi bi-envelope-fill mx-3" viewBox="0 0 16 16">
