    ...
    <div class="row mt-3 ml-3">
        <div class="column mx-2">
            <div class="card border-info text-dark mb-3" style="width: 18rem;">
                <div class="card-body">
                    {{-- <div class="card-body-icon mt-3" style="position: absolute;">
                        <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor" class="bi bi-cart-plus" viewBox="0 0 16 16">
        ...
        <div class="column mx-2">
            <div class="card border-dark text-dark text-justify mb-3" style="width: 18rem; ">
                <div class="card-body">
                    <div class="d-flex">
                        <div class="w-100">
