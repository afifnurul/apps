...
<div class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
    <div class="pr-5">
        <div class="container pr-5">
            ...
            <form method="POST" action="{{ route('admin.pengembalian.form.simpan') }}">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <input type="text" class="form-control" id="inlineFormInputGroup" name="denda" placeholder="Nominal Denda">
                    </div>
                </div>
